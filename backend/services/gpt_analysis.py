...
def _build_local_feedback(transcript: str, word_confidences: List[Dict[str, Any]], speech_metadata: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        "overall_explanation": "Your delivery sounds clear overall. A few words could be spoken more deliberately to improve articulation and confidence.",
        "mistakes": mistakes,
        "general_suggestions": [
...
def generate_explanations(transcript: str, word_confidences: List[Dict[str, Any]], speech_metadata: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if api_key and transcript:
        try:
            ...
            prompt = (
                "You are an English pronunciation coach. Use the transcript, word confidence estimates, and speech metadata only to explain pronunciation quality. "
                "Generate a learner-friendly explanation, list of mistakes, and improvement tips. Return ONLY valid JSON with keys overall_explanation, mistakes, general_suggestions."
            ...
            if content:
                ...
                return {
                    "overall_explanation": sanitize_text(parsed.get("overall_explanation", "")),
    ...
    return _build_local_feedback(transcript, word_confidences, speech_metadata)
